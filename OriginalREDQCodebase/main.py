...
def redq_sac(env_name, seed=0, epochs='mbpo', steps_per_epoch=1000,
             ...
             method="redq", spectral_norm=False, l1=0.0, l2=0.0
             ):
    """
    ...
    assert method in ["sac", "redq", "duvn",
                      "monosac"], "illigal method:" + str(method)
    if method == "sac":
    ...
    agent = REDQSACAgent(env_name, obs_dim, act_dim, act_limit, device,
                         ...
                         policy_update_delay,
                         target_drop_rate=target_drop_rate, layer_norm=layer_norm, spectral_norm=spectral_norm, l1=l1, l2=l2)  # added by TH 20211206 <- bug fix 20211207
...
if __name__ == '__main__':
    ...
    parser.add_argument("-method", default="sac",
                        choices=["sac", "redq", "duvn", "monosac"], help="method, default=sac")
    ...
    parser.add_argument("-spectral_norm", type=int, default=0, choices=[0, 1],
                        help="Using spectral normalization on the second last layer for training critics if set to 1 (TH), default=0")
    parser.add_argument('-l1', type=float, default=0.0,
                        help="L1 norm penalization constant for loss")
    parser.add_argument("-l2", type=float, default=0.0,
                        help="L2 norm penalization constant for loss")
    ...
    parser.add_argument("-target_entropy", type=float,
                        default=None, help="target entropy , default=Num action")
